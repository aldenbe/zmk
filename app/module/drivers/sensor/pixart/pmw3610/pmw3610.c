...
static int pmw3610_attr_set(const struct device *dev, enum sensor_channel chan,
    ...
    case PMW3610_ATTR_REST1_SAMPLE_TIME:
        err = set_sample_time(dev, PMW3610_REG_REST1_PERIOD, PMW3610_SVALUE_TO_TIME(*val));
        break;

    case PMW3610_ATTR_REST2_SAMPLE_TIME:
        err = set_sample_time(dev, PMW3610_REG_REST2_PERIOD, PMW3610_SVALUE_TO_TIME(*val));
        break;

    case PMW3610_ATTR_REST3_SAMPLE_TIME:
        err = set_sample_time(dev, PMW3610_REG_REST3_PERIOD, PMW3610_SVALUE_TO_TIME(*val));
        break;
